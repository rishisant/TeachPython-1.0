...
x = #Input number equal to or below 5 here
if x = 5:
...
if inp1 == '+':
	...
	func = 2
elif inp1 == #Finish The Next Two Lines of Code
...
inp3 = #Finish this with the second number

# Now, convert 'inp2' and 'inp3' to floating point values.

inp2 = float(inp2)
inp3 = #Finish this part!
...
if func == 1:
	...
	#FINISH THIS LINE WITH MULTIPLICATION
elif func == 4:
	#FINISH THIS LINE WITH DIVISION
